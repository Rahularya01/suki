...
import SubBackgroundGif from "../../assets/gifs/blossom-gif.webp";
    ...
    <div className="w-full h-full relative">
      ...
      >
        <div className="w-full flex justify-center items-center flex-col md:flex-row md:space-x-4 m-auto">
          ...
          <div className="w-full h-max flex flex-col justify-center items-center space-y-4 md:w-6/12 z-10 order-1 p-2 md:order-2 relative banner-right__side">
            <div className="blur-bg"/>
              ...
              <div className="flex flex-col justify-center items-center z-10">
                ...
                <h2 className="text-white text-center text-base lg:text-lg xl:text-2xl mt-3">
                  Suki invites you to join her on a world of adventures. 5555
